...
public class idx3d_TestApp extends Frame
{
	...
	public idx3d_Viewer createScene()
	{
		idx3d_Viewer viewer=new idx3d_Viewer();
		idx3d_Scene scene=viewer.getScene();
		...
		// Create background image 
			...
			scene.environment.setBackground(idx3d_TextureFactory.bilinearResample(bkgrd,256,256)); 

		// Add materials
				
			idx3d_Material crystal=new idx3d_Material("materials/glass.material");
			crystal.setReflectivity(255);
			scene.addMaterial("Crystal",crystal);
			
			idx3d_Material plastic=new idx3d_Material(new idx3d_Texture("textures/texture.jpg"));
