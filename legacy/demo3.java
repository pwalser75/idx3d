...
public final class demo3 extends Applet implements Runnable
{
	...
	public void init()
	{
		...
		// BUILD SCENE
			...
			scene.addMaterial("Stone1",new idx3d_Material(new idx3d_Texture(getDocumentBase(),"textures/stone1.jpg")));
			scene.addMaterial("Stone2",new idx3d_Material(new idx3d_Texture(getDocumentBase(),"textures/stone2.jpg")));
			scene.addMaterial("Stone3",new idx3d_Material(new idx3d_Texture(getDocumentBase(),"textures/stone3.jpg")));
			scene.addMaterial("Stone4",new idx3d_Material(new idx3d_Texture(getDocumentBase(),"textures/stone4.jpg")));
			...
			try{
				new idx3d_3ds_Importer().importFromStream(new java.net.URL(getDocumentBase(),"meshes/wobble.3ds").openStream(),scene);
				scene.rebuild();
