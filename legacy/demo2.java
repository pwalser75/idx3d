...
public final class demo2 extends Applet implements Runnable
{
	...
	public void init()
	{
		...
		// BUILD SCENE
			...
			idx3d_Texture heightMap=new idx3d_Texture(getImage(getDocumentBase(),"textures/terrain.gif"));
			
			m.setTexture(new idx3d_Texture(getImage(getDocumentBase(),"textures/terrain.jpg")));
