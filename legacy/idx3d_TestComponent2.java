...
public class idx3d_TestComponent2 extends Panel implements Runnable
{
	...
	public void init()
	{
		...
		// BUILD SCENE
			...
			idx3d.implicit.BlobSurface surface=new idx3d.implicit.BlobSurface(new idx3d_Vector(0,0,0),new idx3d_Vector(4,4,4));
			surface.setIsolevel(6f);
			
			
			for (int i=0;i<64;i++)
				surface.addBlob(idx3d_Vector.random(1.44f),idx3d_Math.random(0.08f,0.24f));
			
			idx3d_Object obj=idx3d.implicit.MarchingCubes.generateIsosurface(40, surface);
			
			scene.addObject("Isosurface",obj);
