...
public final class demo6 extends Applet implements Runnable
{
	...
	public void init()
	{
		...
		// BUILD SCENE
			...
			metal.setEnvmap(new idx3d_Texture(getDocumentBase(),"textures/chrome.jpg"));
			...
			try{
				new idx3d_3ds_Importer().importFromURL(new java.net.URL(getDocumentBase(),"meshes/wobble.3ds"),scene);
				scene.rebuild();
