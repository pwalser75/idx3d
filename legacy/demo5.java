	...
	public void init()
	{
		...
		// BUILD SCENE
			...
			// Material setup
				...
				scene.addMaterial("Glass",new idx3d_Material(getDocumentBase(),"materials/glass.material"));
				scene.addMaterial("Chrome",new idx3d_Material(getDocumentBase(),"materials/chrome.material"));
				scene.addMaterial("Blue",new idx3d_Material(getDocumentBase(),"materials/blue.material"));
			...
			try{
				new idx3d_3ds_Importer().importFromURL(new java.net.URL(getDocumentBase(),"meshes/demo5.3ds"),scene);
			}
			...
			idx3d_Texture bkgrd=idx3d_TextureFactory.blendTopDown(
				...
				new idx3d_Texture(getDocumentBase(),"textures/idxbkgrd.jpg"));
