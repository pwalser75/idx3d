...
public final class link3d extends Applet implements Runnable
{
	...
	String link1URL, link2URL, link3URL;
	String img1,img2,img3;
	
	public void init()
	{		
		link1URL=getParameter("link1");
		link2URL=getParameter("link2");
		link3URL=getParameter("link3");
		img1=getParameter("img1");
		img2=getParameter("img2");
		img3=getParameter("img3");
		...
		// BUILD SCENE
			...
			scene.addMaterial("Link1", new idx3d_Material(new idx3d_Texture(getImage(getDocumentBase(),img1))));
			scene.addMaterial("Link2", new idx3d_Material(new idx3d_Texture(getImage(getDocumentBase(),img2))));
			scene.addMaterial("Link3", new idx3d_Material(new idx3d_Texture(getImage(getDocumentBase(),img3))));
