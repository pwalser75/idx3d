...
public class demo4 extends Applet implements Runnable
{
	...
	public void init()
	{
		...
		// BUILD SCENE
			...
			idx3d_Texture envmap=new idx3d_Texture(getDocumentBase(),"textures/skymap.jpg");
			idx3d_Texture texture=new idx3d_Texture(getDocumentBase(),"textures/spectrum.jpg");
			...
			idx3d_Material mode4=new idx3d_Material(getDocumentBase(),"materials/glass.material");
