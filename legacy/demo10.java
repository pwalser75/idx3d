...
public final class demo10 extends Applet implements Runnable
{
	...
	{		
		...
		// BUILD SCENE
			...
			metal.setEnvmap(new idx3d_Texture(getImage(getDocumentBase(),"textures/chrome.jpg")));
			...
			scene.addMaterial("Link1", new idx3d_Material(new idx3d_Texture(getImage(getDocumentBase(),"textures/link1.jpg"))));
			scene.addMaterial("Link2", new idx3d_Material(new idx3d_Texture(getImage(getDocumentBase(),"textures/link2.jpg"))));
			scene.addMaterial("Link3", new idx3d_Material(new idx3d_Texture(getImage(getDocumentBase(),"textures/link3.jpg"))));
			...
			try{
				new idx3d_3ds_Importer().importFromURL(new java.net.URL(getDocumentBase(),"meshes/linkable.3ds"),scene);
