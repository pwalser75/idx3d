...
public final class idx3d_Scene extends idx3d_CoreObject
{
	...
	// D A T A   S T R U C T U R E S
		...
		public Hashtable particleClusterData=new Hashtable();
	...
	// D A T A   M A N A G E M E N T
		...
		public void rebuild()
		{
			if (objectsNeedRebuild)
			{
				...
				Enumeration enumeration=objectData.elements();
				for (int i=objects-1;i>=0;i--)
				{
					object[i]=(idx3d_Object)enumeration.nextElement();
					object[i].id=i;
					object[i].rebuild();
				}
			...
			if (lightsNeedRebuild)
			{
				...
				Enumeration enumeration=lightData.elements();
				for (int i=lights-1;i>=0;i--) light[i]=(idx3d_Light)enumeration.nextElement();
	...
	// A C C E S S O R S
		...
		public idx3d_ParticleCluster particleCluster(String key) { return (idx3d_ParticleCluster) particleClusterData.get(key);}
	...
	// O B J E C T   M A N A G E M E N T
		...
		public void addParticleCluster(String key, idx3d_ParticleCluster p) {particleClusterData.put(key,p);}
		public void removeParticleCluster(String key) { particleClusterData.remove(key); }
