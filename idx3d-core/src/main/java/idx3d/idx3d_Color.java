...
// | * Wilfred L. Guerin,    for testing, bug report, and tons of brilliant suggestions
// | * Sandy McArthur,       for reverse loops
// | * Dr. Douglas Lyons,    for mentioning idx3d1 in his book
// | * Hugo Elias,           for maintaining his great page
// | * the comp.graphics.algorithms people, for scientific concerns
// | * Tobias Hill,          for inspiration and awakening my interest in java gfx coding
// | * Kai Krause,           for inspiration and hope
// | * Incarom & Parisienne, for keeping me awake during the long coding nights
...
// Faster Color handling for 24bit colors
{
	...
	// PUBLIC STATIC METHODS
		...
		public static final int gray(int val)
		{
			int i=idx3d_Math.crop(val,0,256);
		...
		public static final int subneg(int color1, int color2)
		...
		public static final int inv(int color)
		// returns the inverse of the given color
		{
			return ALPHA|(~color);
		}
		
		public static final int mix(int color1, int color2)
		...
		public static final int transparency(int bkgrd, int color, int alpha)
		...
		public static final int random(int color, int delta)
		{
			int r=(color>>16)&255;
			int g=(color>>8)&255;
			int b=color&255;
		...
		public static final int[] makeGradient(int colors[], int size)
		{
		...
		public static final int[] getGlowPalette(int color)
		{
			int r,g,b;
