...
// defines a 3d vector
{
	...
	// P U B L I C   M E T H O D S
		...
		public static float distance(idx3d_Vector a, idx3d_Vector b)
		// returns the distance between 2 vectors
		{
			return idx3d_Vector.sub(a,b).length();
		}
		...
		public static idx3d_Vector random(float x, float y, float z)
		// returns a random vector
		{
			return new idx3d_Vector(x*idx3d_Math.random(),y*idx3d_Math.random(),z*idx3d_Math.random());
		}
		
		public static idx3d_Vector center(idx3d_Vector a, idx3d_Vector b)
		// substracts 2 vectors
		{
			return new idx3d_Vector((a.x+b.x)/2,(a.y+b.y)/2,(a.z+b.z)/2);
		}
